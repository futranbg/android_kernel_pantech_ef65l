...
#ifdef ITO_TYPE_CHECK
#if  defined (CONFIG_MACH_MSM8X60_EF65L)	// pz2123
...
void off_hw_setting(void)
{
	...
	// Init 3.3V regulator
#if defined(CONFIG_SKY_EF39S_BOARD) || defined(CONFIG_SKY_EF40K_BOARD) || defined(CONFIG_SKY_EF40S_BOARD)  || defined (CONFIG_MACH_MSM8X60_EF65L)
	vreg_touch_3_3 = regulator_get(NULL, "8058_l2");
...
{
	dbg_func_in();
#if defined(CONFIG_SKY_EF39S_BOARD) || defined(CONFIG_SKY_EF40K_BOARD) || defined(CONFIG_SKY_EF40S_BOARD) || defined(CONFIG_MACH_MSM8X60_EF65L) || defined(CONFIG_PANTECH_QUANTINA_BOARD)
	gpio_set_value(GPIO_TOUCH_RST, 0);
	dbg("TOUCH_RST Low.\n");
